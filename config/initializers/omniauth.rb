Rails.application.config.middleware.use OmniAuth::Builder do
  if ENV["RAILS_ENV"] == "production"
    ...
    provider :facebook, '205001809513746', '866d7ac10babe209068c881183d1ef8f', :client_options => {:ssl => {:ca_file => '/usr/share/curl/curl-ca-bundle.crt'}} #, :scope => "user_likes,user_birthday,offline_access,publish_stream,user_education_history,user_location,user_relationships"  
  end
end
